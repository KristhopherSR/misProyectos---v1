...
def alumnosUpdate(request):
    if request.method == 'POST':
        ...
        alumno.feche_nacimiento = fechaNac
...
def generos_edit(request, pk):
    try:
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                form.save()
                mensajes="Bien, datos actualizados..."
                context = {'genero': genero, 'form': form, 'mensaje': mensajes}
